...
(function () {
  ...
  /* ---------------------------- MAPS ---------------------------- */
  const maps = [
    { id: "map-1", accent: "#2bd8c6", glyph: "map", visits: 1840, updated: "2026/06/18", link: "", tags: [{ t: "t-new", k: "tag.new" }],
    ...
    { id: "map-2", accent: "#58b6ff", glyph: "map", visits: 1206, updated: "2026/06/12", link: "", tags: [],
    ...
    { id: "map-3", accent: "#9b82ff", glyph: "map", visits: 954, updated: "2026/05/30", link: "", tags: [{ t: "t-update", k: "tag.update" }],
    ...
    { id: "map-4", accent: "#4fd88a", glyph: "map", visits: 732, updated: "2026/05/22", link: "", tags: [],
    ...
    { id: "map-5", accent: "#ffcf5a", glyph: "map", visits: 1588, updated: "2026/06/05", link: "", tags: [{ t: "t-new", k: "tag.new" }],
    ...
    { id: "map-6", accent: "#ff7eb0", glyph: "map", visits: 621, updated: "2026/05/15", link: "", tags: [],
  ...
  /* --------------------------- SYSTEMS -------------------------- */
  const systems = [
    { id: "sys-1", accent: "#2bd8c6", glyph: "system", downloads: 421, updated: "2026/06/16", isFree: false, link: "",
    ...
    { id: "sys-2", accent: "#4fd88a", glyph: "system", downloads: 987, updated: "2026/06/10", isFree: true, link: "",
    ...
    { id: "sys-3", accent: "#9b82ff", glyph: "system", downloads: 312, updated: "2026/05/28", isFree: false, link: "",
    ...
    { id: "sys-4", accent: "#58b6ff", glyph: "system", downloads: 645, updated: "2026/06/02", isFree: true, link: "",
      prices: null, tags: [],
    ...
    { id: "sys-5", accent: "#ffcf5a", glyph: "system", downloads: 278, updated: "2026/05/19", isFree: false, link: "",
    ...
    { id: "sys-6", accent: "#ff7eb0", glyph: "system", downloads: 519, updated: "2026/05/11", isFree: true, link: "",
      prices: null, tags: [],
  ...
  /* --------------------------- COURSES -------------------------- */
  const courses = [
    { id: "crs-1", accent: "#2bd8c6", glyph: "course", students: 124, lessons: 18, duration: "4h 30m", updated: "2026/06/14", isFree: true, link: "",
    ...
    { id: "crs-2", accent: "#9b82ff", glyph: "course", students: 86, lessons: 24, duration: "6h 10m", updated: "2026/06/08", isFree: false, link: "",
    ...
    { id: "crs-3", accent: "#58b6ff", glyph: "course", students: 54, lessons: 20, duration: "5h 00m", updated: "2026/05/26", isFree: false, link: "",
    ...
    { id: "crs-4", accent: "#4fd88a", glyph: "course", students: 98, lessons: 15, duration: "3h 40m", updated: "2026/06/01", isFree: true, link: "",
      level: { ar: "مبتدئ", en: "Beginner" }, prices: null, tags: [{ t: "t-course", k: "tag.course" }],
  ...
  const forumCats = [
    { id: "cat-1", icon: "forum",   topics: 8, replies: 34,
    ...
    { id: "cat-2", icon: "info",    topics: 15, replies: 62,
    ...
    { id: "cat-3", icon: "sparkle", topics: 6, replies: 21,
  ...
  const posts = [
    { id: "post-1", accent: "#2bd8c6", glyph: "bell", date: "2026/06/21", views: 312, replies: 9,
      ...
      reacts: r(18, 0, 11, 6, 9, 4, 1) },
    { id: "post-2", accent: "#4fd88a", glyph: "system", date: "2026/06/15", views: 184, replies: 5,
      author: { name: "فريق نيوم", avatar: av(1) },
      ...
      reacts: r(7, 0, 5, 2, 8, 1, 0) },
    { id: "post-3", accent: "#ffcf5a", glyph: "star", date: "2026/06/09", views: 246, replies: 12,
      author: { name: "فريق نيوم", avatar: av(1) },
