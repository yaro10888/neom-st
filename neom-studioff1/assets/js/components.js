...
(function () {
    ...
    return `<div class="nav-wrap" id="navWrap">
      <nav class="nav" aria-label="القائمة الرئيسية">
        <a class="brand" id="nav-brand" href="index.html" data-route="/home">
          <img src="assets/img/logo.svg" alt="Neom studio" />
          <b>Neom studio</b>
        </a>
      ...
      <div class="container">
        <div class="footer-top">
          <div class="footer-brand">
            <a class="brand" href="index.html"><img src="assets/img/logo.svg" alt="Neom studio"/><b>Neom studio</b></a>
  ...
  NEOM.openModal = function (html, opts = {}) {
    ...
    box.className = "modal" + (opts.sm ? " modal-sm" : "");
    box.innerHTML = html;
